...
export function Settings(props: SettingsPropsType) {
    ...
    return <div className={'wrapper'}>
        <div className={'incReset settings'}>
            ...
            <Inputs title={'Start Value'} valueInput={props.setStartValue} value={props.startValue} checkValue={checkInputsValue}/>

            <Inputs title={'Max Value'} valueInput={props.setMaxValue} value={props.maxValue} checkValue={checkInputsValue}/>
        </div>
